...
modded class Animal_BosTaurus //cow
{
	override bool Neo_Eggs_isBigGame()
	{
		return true;
	}
}

modded class Animal_CanisLupus //wolf
{
	override bool Neo_Eggs_isPredator()
	{
		return true;
	}
}

modded class Animal_CapraHircus //goat
{
	override bool Neo_Eggs_isBigGame()
	{
		return true;
...
modded class Animal_CapreolusCapreolus // roe deer
{
	override bool Neo_Eggs_isBigGame()
	{
		return true;
...
modded class Animal_CervusElaphus //deer
{
	override bool Neo_Eggs_isBigGame()
	{
		return true;
...
modded class Animal_RangiferTarandus //reindeer
{
	override bool Neo_Eggs_isBigGame()
	{
		return true;
...
modded class Animal_GallusGallusDomesticus //chicken
{
	override bool Neo_Eggs_isAmbient()
	{
		return true;
	}
}

modded class Animal_OvisAries //sheep
{
	override bool Neo_Eggs_isBigGame()
	{
		return true;
...
modded class Animal_SusDomesticus //pig
{
	override bool Neo_Eggs_isBigGame()
	{
		return true;
...
modded class Animal_SusScrofa // boar
{
	override bool Neo_Eggs_isBigGame()
	{
		return true;
...
modded class Animal_UrsusArctos // bear
{
	override bool Neo_Eggs_isPredator()
	{
		return true;
...
modded class Animal_LepusEuropaeus //hare
{
	override bool Neo_Eggs_isAmbient()
	{
		return true;
...
modded class Animal_VulpesVulpes //fox
{
	override bool Neo_Eggs_isAmbient()
	{
		return true;
